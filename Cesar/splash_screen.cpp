...
//button
Fl_Button starte(700,0,75,75,"Next");
//box explain
...
Fl_Box background3(0,0,width,height);
Fl_JPEG_Image im1("materials/Konoha.jpg");
//box
Fl_Box difficulty(150,40,700,100,"Which level would you like to play?");
//button1
Fl_Button l1(250,450,75,75,"Level 1");
//button2
Fl_Button l2(350,450,75,75,"Level 2");
//button3
Fl_Button l3(450,450,75,75,"Level 3");
//button4
Fl_Button l4(550,450,75,75,"Level 4");
//button5
Fl_Button l5(650,450,75,75,"Level 5");
/*****************************************************/
...
void l1_callback(Fl_Widget* , void *) {
	win2.hide();
	scoreboard.show();					//WHEN YOU CHOOSE THE LEVEL l[]
	NUM_ROUNDS = NUM_ROUNDS * 1; 		//IT WILL MULTI. BY 32, TO 
	num_rounds();						//GET NUM_ROUNDS
...
void l2_callback(Fl_Widget* , void *) {
	win2.hide();
	scoreboard.show();				//WHEN YOU CHOOSE THE LEVEL l[]
	NUM_ROUNDS = NUM_ROUNDS * 2;	//IT WILL MULTI. BY 32, TO 
	num_rounds();					//GET NUM_ROUNDS
...
void l3_callback(Fl_Widget* , void *) {
	win2.hide();
	scoreboard.show();				//WHEN YOU CHOOSE THE LEVEL l[]
	NUM_ROUNDS = NUM_ROUNDS * 4;	//IT WILL MULTI. BY 32, TO
	num_rounds();					//GET NUM_ROUNDS
...
void l4_callback(Fl_Widget* , void *) {
	win2.hide();
	scoreboard.show();				//WHEN YOU CHOOSE THE LEVEL l[]
	NUM_ROUNDS = NUM_ROUNDS * 8;	//IT WILL MULTI. BY 32, TO
	num_rounds();					//GET NUM_ROUNDS
...
void l5_callback(Fl_Widget* , void *) {
	win2.hide();
	scoreboard.show();				//WHEN YOU CHOOSE THE LEVEL l[]
	NUM_ROUNDS = NUM_ROUNDS * 16;	//IT WILL MULTI. BY 32, TO
	num_rounds();					//GET NUM_ROUNDS
}
/*****************************************************/
