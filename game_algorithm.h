...
Fl_Radio_Button red(250,350,75,75, "Red");
Fl_Radio_Button white(350,350,75,75, "White");
Fl_Radio_Button blue(150,350,75,75,"Blue");
...
Fl_Button time_right(450,350,75,75,"Timer");
